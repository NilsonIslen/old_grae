<?php
                        ...
                        echo "<input type='number' min='0' max='$OD14x5' name='D14x5' placeholder='D14x5'>";
                        echo "<input type='number' min='0' max='$OD16x5' name='D16x5' placeholder='D16x5'>";
                        echo "<input type='number' min='0' max='$OMinx20' name='Minx20' placeholder='Minx20'>";
